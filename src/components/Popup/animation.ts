...
export function center(node, { delay = 0, duration = 300 }) {
  const initScale = 0.8;
  const scaleMax = 1.1;
  const tMax = 0.75;
  return {
...
export function top(node, { delay = 0, duration = 300 }) {
  return {
    delay,
    duration,
    css: (t) => {
...
export function right(node, { delay = 0, duration = 300 }) {
  return {
    delay,
    duration,
    css: (t) => {
...
export function bottom(node, { delay = 0, duration = 300 }) {
  return {
    delay,
    duration,
    css: (t) => {
...
export function left(node, { delay = 0, duration = 300 }) {
  return {
    delay,
    duration,
    css: (t) => {
